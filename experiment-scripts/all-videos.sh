...
do
    ...
    # Ground truth
    python play_video.py --vid-name results/${vid_name}_gt --high-src ${original_images} --resolutions 1.0 \
    ...
    do
        ...
        python play_video.py --vid-name results/${vid_name}_mpeg_${res} --resolutions ${res} \
...
do
    ...
    do
        ...
        python play_video.py --vid-name results/${vid_name}_dds_${low}_${high} --high-src ${original_images} \
